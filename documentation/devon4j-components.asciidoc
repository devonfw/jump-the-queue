...
== devon4j Components
image::images/devon4j/4.Components/devon4j_architecture.png[devon4j Architecture, 450]
...
_MyThaiStar_ is an application of a restaurant that allows *booking* tables, and *order* different *dishes* so the main _devon4j_ components are:

image::images/devon4j/4.Components/mythaistar_components.png[MyThaiStar Components, 250]
...
image::images/devon4j/4.Components/mythaistar_component_structure.png[MyThaiStar Component Structure, 250]
...
image::images/devon4j/4.Components/mythaistar_component_core1.png[MyThaiStar Component Core 1, 250]
...
image::images/devon4j/4.Components/mythaistar_component_core2.png[MyThaiStar Component Core 2]

== Create your components

After you have completed link:build-devon4j-application.asciidoc[your own devon4j app] creation, we are going to create our first app component.

Going back to our example application, link:jump-the-queue-design.asciidoc[JumpTheQueue], we need to provide two basic functionalities:
...
image::images/devon4j/4.Components/visitor-accesscode.png[Visitor AccessCode, 400]
...
image::images/devon4j/4.Components/visitor_component_packages1.png[Visitor Component Packages 1]

image::images/devon4j/4.Components/visitor_component_packages2.png[Visitor Component Packages 2, 450]

Now create a new java class in the just created `visitormanagement.dataaccess.api` package

image::images/devon4j/4.Components/visitor_component_entity1.png[Visitor Component Entity 1]

and call it _VisitorEntity_

image::images/devon4j/4.Components/visitor_component_entity2.png[Visitor Component Entity 2, 450]
...
image::images/devon4j/4.Components/visitor_component_gettersandsetters.png[Visitor Component Getters and Setters]
...
image::images/devon4j/4.Components/jumpthequeue_emptycomponents.png[JumpTheQueue empty Components 1]
...
image::images/devon4j/4.Components/jumpthequeue_emptycomponents2.png[JumpTheQueue empty Components 2]
...
image::images/devon4j/4.Components/cobigen0.png[CobiGen Health Check 1]

The next dialogs will show us if there are outdated templates. In that case we can solve it clicking the _Update_ button.

image::images/devon4j/4.Components/cobigen_health1.png[CobiGen Health Check 2, 350]

image::images/devon4j/4.Components/cobigen_health2.png[CobiGen Health Check 3, 350]
...
image::images/devon4j/4.Components/cobigen1.png[Cobigen Generate]
...
image::images/devon4j/4.Components/cobigen2_crud_springdata_repository.png[CobiGen CRUD Spring Data Repository]

* _CRUD REST services_: generates a complete service layer with CRUD operations for our entity exposed as a REST service.

image::images/devon4j/4.Components/cobigen2_crud_rest_services.png[CobiGen CRUD REST Services]

* _CRUD UC logic_: generates the logic layer dividing the implementation in different use cases.

image::images/devon4j/4.Components/cobigen2_crud_uc_logic.png[CobiGen CRUD UC Logic]
...
image::images/devon4j/4.Components/cobigen2_entity_infrastructure.png[CobiGen Entity Infrastructure]

* _TO's_: generates the related _Transfer Objects_, that we will explain in next chapters of this tutorial

image::images/devon4j/4.Components/cobigen2_to.png[CobiGen Transfer Objects]
