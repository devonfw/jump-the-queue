...
. Implementation of the `usecasefind` layer in the _logic_ layer.
. Implementation of the `usecasemanage` layer in the _logic_ layer.
...
. Definition of `usecasefind` in the _logic_ layer.
. Definition of `usecasemanage` in the _logic_ layer.
