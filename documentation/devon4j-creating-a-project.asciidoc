...
** Server path: hit Enter. (So it will be the current directory).

** Servername: `myServer` (or any name you like).

** Package name: `com.capgemini.myServer` 
...
** Server path: `../MyProject/Servers`

** Servername: mp

** Package name: com.devonfw.application.mp
