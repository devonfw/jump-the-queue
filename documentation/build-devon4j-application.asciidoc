...
image::images/devon/devon_dist.png[devonfw Distributon Contents, 450]
...
image::images/devon4j/3.BuildYourOwn/newapp1.png[Devcon devon4j Dropdown Menu, 450]
...
image::images/devon4j/3.BuildYourOwn/devcon_devon4j_create.png[Devcon devon4j Create Page, 450]
...
image::images/devon4j/3.BuildYourOwn/newapp2.png[Maven Project Import Screen]

Browse for the _jumpthequeue_ project

image::images/devon4j/3.BuildYourOwn/newapp3.png[Maven Project Import Selection]
...
image::images/devon4j/3.BuildYourOwn/run.png[Spring Boot Run Java Application]
...
image::images/devon4j/3.BuildYourOwn/login.png[Backend Login Page]
...
image::images/devon4j/3.BuildYourOwn/devcon_devon4j_project_exp.PNG[API Core Server Packages, 500]
...
image::images/devon4j/3.BuildYourOwn/devcon_devon4j_flyway.PNG[Database Files, 250]

* Bean mapper ready

image::images/devon4j/3.BuildYourOwn/emptyapp_beanmapper.png[Bean Mapper, 650]

* Basic security enabled (based on _Spring Security_)

image::images/devon4j/3.BuildYourOwn/emptyapp_security.png[Spring Security, 650]

* Unit test support and model

image::images/devon4j/3.BuildYourOwn/emptyapp_test.png[Unit Test Model, 650]
