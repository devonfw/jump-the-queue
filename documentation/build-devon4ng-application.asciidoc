...
[NOTE]
====
Learn more about creating new components in devon4ng xref:angular-components#Create-a-new-Component[here].
====
...
[NOTE]
====
Learn more about the root component in devon4ng xref:angular-components#Root-Component[here].
====
...
[NOTE]
====
Learn more about routing in devon4ng xref:angular-components#Routing[here].
====
