...
[NOTE]
====
Please note, that the class `VisitormanagementTest` in the code snippet above, *extends* the class `ComponentTest`. Please make sure, that this is the case in your code too.
====
...
If we do it with _JumpTheQueue_ project
----
