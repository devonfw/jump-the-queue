...
== devon4j Tools
The following tools are included in the https://github.com/devonfw/ide[devon IDE], which -- mong many other tasks -- can create, run or deploy devon4j applications, avoiding lots of manual work.
