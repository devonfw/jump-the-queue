...
public class UcManageAccessCodeImpl extends AbstractAccessCodeUc implements UcManageAccessCode {
  ...
  public AccessCodeEto saveAccessCode(AccessCodeEto accessCodeEto) {
    ...
    accessCodeEntity.setVisitor(getCurrentVistior());
  ...
  private VisitorEntity getCurrentVistior() {

    Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
    String currentPrincipalName = authentication.getName();

    List<VisitorEntity> visitors = this.visitorRepo.findByUsername(currentPrincipalName);
